...
path_max = 'E:\指静脉与指背纹\Work\Code\NewestDatabase\max_cur\';
path_max_dilate = 'E:\指静脉与指背纹\Work\Code\NewestDatabase\max_cur_dilate\';
se = strel('disk', 7);
...
for sampleID = 1:200
    ...
    for dir = 1:3
        ...
        for id = 1:6
            ...
            path3_max_dilate = [path2_max_dilate, num2str(id, '%d\\')];
